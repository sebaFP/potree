    ...
    if (pointclouds.length > 0) {
      for (let pointcloud of pointclouds) {
        ...
        if (pointOnCloud && pointOnMesh) {
          ...
          let closest =
            distanceToCloud < distanceToMesh ? pointOnCloud : pointOnMesh;
          closestDistance =
            closest === pointOnCloud ? distanceToCloud : distanceToMesh;
          selectedPointcloud = pointcloud;
          closestIntersection =
            closest === pointOnCloud
              ? pointOnCloud.position
              : pointOnMesh.position;
